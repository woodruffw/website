...
\section{EDUCATION} {\sl The Bronx High School of Science,} Bronx, NY,
                graduated June 2014 with honors. \\
...
\section{SKILLS} {\sl Languages:} C, Java, Perl, C++, C\#, shell, HTML/CSS/JS, NASM, and Lisp. \\
				{\sl Hardware:} ARM boards (Beaglebone, Raspberry Pi), AVR controllers (Arduino). \\
				{\sl Frameworks and Libraries:} OpenGL, ImageMagick, cURL, .NET, and X11. \\
				{\sl Software (development):} Inkscape, GIMP, Audacity, Reason, and Visual Studio. \\
				{\sl Software (business):} Microsoft Office/LibreOffice, Excel/LibreOffice Calc. \\
                {\sl Operating Systems:} Linux, *BSD, Solaris, Darwin (OS X), and Windows.
 
\section{EXPERIENCE} 
				{\sl Contracted Computer Services and Repair} \hfill February 2013 - July 2014 \\
